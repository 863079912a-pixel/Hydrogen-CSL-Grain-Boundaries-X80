# -*- coding: utf-8 -*-
"""
Stage III-3 dynamic tensile fracture test for 025/050/100 multi-H GB coverage models.
...
# ============================================================
# 0. 工作区、模型路径与势函数：multiH 025/050/100cov
# ============================================================
WORKDIR = Path(r"C:\Users\Admin01\Desktop\stage3_fracture_response_multiH")
MULTIH_MODEL_DIR = Path(r"C:\Users\Admin01\Desktop\multiH_GB_models")

LAMMPS_EXE = Path(r"C:\Users\Admin01\AppData\Local\LAMMPS 64-bit 10Dec2025-MSMPI with Python\bin\lmp.exe")
POTENTIAL_FILE = Path(r"C:\Users\Admin01\Desktop\stage3_fracture_response_multiH\potential\BOP1.poly")

SIGMAS_TO_RUN = ["sigma3", "sigma5", "sigma11", "sigma17"]

# 025/050/100cov 高覆盖度多氢模型。
COVERAGES_TO_RUN = ["025cov", "050cov", "100cov"]

# "all" or list such as ["sigma5_GB_050cov", "sigma5_GB_100cov"]
CASES_TO_RUN = "all"
...
# ============================================================
# 128 logical CPU cores on the workstation. For 12 multiH cases:
# MAX_WORKERS=12 and MPI_RANKS_PER_JOB=10 -> about 120 MPI ranks total.
TOTAL_CPU_CORES = 128
...
def main():
    ...
    if SHOW_STARTUP_CONFIG or not TERMINAL_BRIEF:
        log("=" * 88)
        log("Stage III-3 multiH 025/050/100 dynamic tensile fracture test: all-GB slow grip")
    ...
    summary_csv = WORKDIR / "summaries" / "phase3_multiH_dynamic_summary_allGB_slow_grip.csv"
